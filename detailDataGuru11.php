...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-50">
     ...
     <center>
         <figure>  <img class="img-circle" src="images/demo/fotoGuru/hersiwi.jpg" style="width: 200px;height:300px;" alt=""> </figure>
            <table class="table" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="fd9c03">
                ...
                <tr>
                    ...
                    <td style="font-weight:bold;">:</td>
                    <td> Wonorejo  Indah Tim, Sur___</td>
                </tr>
                </table>
          </center>
            </main>
            ...
            <center>
                <p> <a href="DataGuruIndex.php" style="font-weight:bold;" > [ Kembali ]</a> </p>
            </center>
