   ...
   echo " 
      ...
      <li class='one_third'>
        <article class='element'>
          <figure><img src='images/demo/kegiatan/$data[foto_judul]' alt=''>
            <figcaption><a class='btn small' href='berita.php'>More</a></figcaption>
          </figure>
          <div class='excerpt'>
            <time datetime='2045-07-$data[foto2]T08:15+00:00' data-title='$data[bulan_kegiatan]'><strong>$data[bulan_kegiatan]</strong> <em>$data[tgl_kegiatan]</em></time>
              <h6 class='heading'><a href='beritaband.html'> <p class='box besar'>$data[judul_kegiatan]</p></a></h6>
          </div>
        </article>
      </li>
