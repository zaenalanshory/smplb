...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header>
                <h5>Edit Foto Prestasi</h5>
            </header>
            <div id="collapse4" class="body">
<?php  
    $nomor=$_GET['nomor'];
    $query_mysqli = mysqli_query($link,"SELECT * FROM prestasi WHERE nomor = '$nomor'")or die(mysqli_error($link));
    while($data = mysqli_fetch_array($query_mysqli)) {
    ?>
    <div id="collapse2" class="body">
	<div style="text-align:center">
	<img src="prestasifoto/<?php echo $data['gambar'] ?>" style="text-align:center" width="20%"/>
	</div>
	<br/><br/>
	
        <form method="post" action="proses_foto_prestasi.php<?php echo "?nomor=$nomor&nip=$nip" ?>" class="form-horizontal" enctype="multipart/form-data">
			
                    <div class="form-group">
                        <label class="control-label col-lg-4">Foto Prestasi</label>
                        <div class="col-lg-4">
        ...
        <i>
		<a href="update_prestasi.php<?php echo "?nomor=$nomor&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i> 
            </div>
                <?php } ?>
                </div>
            </div>
