...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Laporan Contact Us</h5>
            </header>
            <!--<div id="collapse4" class="body"><a  href="#" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Baru</a>-->
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM contact_us"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="10%"><center> No Komentar </center></th>
                        <th width="10%"><center> Nama </center></th>
                        <th width="10%"><center> Email </center></th>
                        <th width="10%"><center> komentar </center></th>
...
$articles="SELECT * FROM contact_us order by no_komentar desc LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM contact_us order by no_komentar desc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="delete_contactus.php?no_komentar=<?php echo $data['no_komentar']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
