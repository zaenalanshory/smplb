...
?>
			...
			<form action="proses_isi_dataajar.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-actions no-margin-bottom">
                        ...
                        <i>
                        <a href="index_dataajar.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
                </form>
            </div> 
    </div>
