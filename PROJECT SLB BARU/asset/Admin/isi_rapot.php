...
?>
        <div id="collapse2" class="body">
			<form action="proses_isi_rapot.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="foto" id="kode_mapel">
                        </div>
                </div>
				...
				<div class="form-actions no-margin-bottom">
                    ...
                    <i>
		<a href="index_rapot.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
				</form>
                </div>
            </div>
