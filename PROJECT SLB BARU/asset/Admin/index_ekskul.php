...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Laporan Ekstrakulikuler</h5>
            </header>
            <div id="collapse4" class="body"><a  href="isi_ekskul.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Ekstrakulikuler </a>
                <?php } ?>
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM ekskul"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="25%"><center> ID </center></th>
                        <th width="25%"><center> Nama Ekskul </center></th>
                        <th width="25%"><center> Foto </center></th>
                        <th width="25%"><center> Deskripsi </center></th>
...
$articles="SELECT * FROM ekskul LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM ekskul order by id desc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_ekskul.php?<?php echo "nip=$nip&id=$data[id]" ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_ekskul.php?<?php echo "nip=$nip&id=$data[id]" ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
    </tr>
    <?php } ?> 
                    </tbody>
</table>
