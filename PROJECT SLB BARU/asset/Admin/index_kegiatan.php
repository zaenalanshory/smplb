...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse4" class="body"><a  href="isi_kegiatan.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Kegiatan</a>
                   <?php } ?>
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM kegiatan"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="10%"><center> ID </center></th>
                        <th width="10%"><center> Judul Kegiatan</center></th>
                        <th width="15%"><center> Tanggal Kegiatan </center></th>
                        <th width="15%"><center> Bulan Kegiatan </center></th>
                        <th width="15%"><center> Foto Judul </center></th>
                        <th width="15%"><center> Foto isi 1 </center></th>
                        <th width="15%"><center> Foto isi 2 </center></th>
                        <th width="15%"><center> Foto isi 3 </center></th>
                        <th width="15%"><center> Deskripsi Kegiatan </center></th>
...
$articles="SELECT * FROM kegiatan LIMIT $start, $perPage";
...
?>
  ...
  <tr align='center'>
            ...
            <td><?php echo $data['bulan_kegiatan']?></td>
            <td><?php echo $data['foto_judul']?></td>
            <td><?php echo $data['foto1']?></td>
            <td><?php echo $data['foto2']?></td>
            <td><?php echo $data['foto3']?></td>
            <td><?php echo $data['isi']?></td>
            <td> <i> <a href="update_kegiatan3.php?id_kegiatan=<?php echo $data['id_kegiatan']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="deletekegiatan.php?id_kegiatan=<?php echo $data['id_kegiatan']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
    </tr>
    <?php } ?> 
                    </tbody>
</table>
