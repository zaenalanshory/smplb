...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header>
                <h5>Input Data Ekstrakulikuler</h5>
            </header>
...
?>
        <div id="collapse2" class="body">
			<form action="proses_isi_ekskul.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
				<div class="form-group">
                        <label class="control-label col-lg-4">Nama Ekskulikuler</label>
                        <div class="col-lg-4">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="file" name="foto" id="foto_judul">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" name="deskripsi" cols="40" rows="4"></textarea>
                        </div>
                </div>
				...
				<div class="form-actions no-margin-bottom">
                    ...
                    <i>
                        <a href="index_ekskul.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
				</form>
                </div>
            </div>
