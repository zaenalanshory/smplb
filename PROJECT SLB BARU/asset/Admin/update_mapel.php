...
$nip = $_GET['nip'];
$query = "SELECT * FROM mapel WHERE kode_mapel = '$kode_mapel'"; //get the data that will be updated
$hasil = mysqli_query($link,$query);
$data  = mysqli_fetch_array($hasil) or die('Error: ' . mysqli_error($link));
?>
     <div id="collapse2" class="body">
         <form action="proses_update_mapel.php?<?php echo "nip=$nip&kode_mapel=$kode_mapel" ?>" method="post" class="form-horizontal">
             <div class="form-group">
                <label class="control-label col-lg-4">Kode Mata Pelajaran</label>
                <div class="col-lg-4">
             ...
             <div class="form-group">
                <label class="control-label col-lg-4">Nama Mapel</label>
                <div class="col-lg-4">
             ...
             <div class="form-actions no-margin-bottom">
                    <input type="hidden" class="form-control" name="kode_mapel" value="<?php echo $data['kode_mapel']; ?>">
