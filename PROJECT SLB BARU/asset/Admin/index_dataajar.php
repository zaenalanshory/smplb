...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Laporan Data Ajar</h5>
            </header>
            <div id="collapse4" class="body"><a  href="isi_dataajar.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Baru</a>
                <?php } ?>
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM data_ajar"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);
    ...
    ?>
                        ...
                        <th width="20%"><center> Kode Mapel </center></th>
...
$articles="SELECT * FROM data_ajar order by kode_mapel ASC LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM data_ajar order by nip asc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_dataajar.php?id_ajar=<?php echo $data['id_ajar']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_dataajar.php?id_ajar=<?php echo $data['id_ajar']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
