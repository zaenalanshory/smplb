...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse4" class="body"><a  href="isi_mapel.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Baru</a>
                <?php } ?>
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM mapel"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="30%"><center> Kode Mapel </center></th>
                        <th width="30%"><center> Nama Mapel </center></th>
...
$articles="SELECT * FROM mapel LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM mapel order by kode_mapel asc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_mapel.php?kode_mapel=<?php echo $data['kode_mapel']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_mapel.php?kode_mapel=<?php echo $data['kode_mapel']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
