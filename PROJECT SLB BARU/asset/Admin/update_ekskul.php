...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header>
                <h5>Edit Data Ekstrakulikuler</h5>
            </header>
...
$query = "SELECT * FROM ekskul WHERE id = $id"; //get the data that will be updated
$hasil = mysqli_query($link,$query);
$data  = mysqli_fetch_array($hasil);
?>
     <div id="collapse2" class="body">
         <form action="proses_update_ekskul.php<?php echo "?nip=$nip&id=$id" ?>" method="post" class="form-horizontal">
             <div class="form-group">
                <label class="control-label col-lg-4">Id</label>
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="id" disabled='disable' value="<?php echo $data['id']; ?>">
                </div>
             </div>
             
             <div class="form-group">
                <label class="control-label col-lg-4">Nama Ekskul</label>
                <div class="col-lg-4">
          ...
          <i>
<a href="index_ekskul.php<?php echo "?id=$id&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
<a href="ubah_fotoekskul.php<?php echo "?id=$id&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Ubah Foto</a>
                </div>
            </div>
      </div>
    </div>
