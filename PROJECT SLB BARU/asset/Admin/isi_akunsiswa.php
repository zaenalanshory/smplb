...
?>
			...
			<form action="proses_isi_akunsiswa.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal">
                   ...
                   <div class="form-group">
                     ...
                     <div class="form-actions no-margin-bottom">
                        <input type="submit" name="ok1" value="SAVE" class="btn btn-primary" style="margin-left: 47%">
                         <i>
		                  <a href="index_akunsiswa.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
                </form>
            </div> 
    </div>
