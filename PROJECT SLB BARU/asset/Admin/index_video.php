...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Silahkan menambahkan video!</h5>
            </header>
    <div class="alert alert-info">
	  <strong>Perhatian!</strong> 
	  <th> </th>
	  Masukkan video embed tanpa iframe dan tanpa tanda petik.
	  <th></th>
	  Contoh: https://www.youtube.com/embed/u02wOGykES8
	  
	</div>
	  <p class="text-primary">Silahkan unggah video dengan mengklik tombol Upload.</p>
	
		<a href="isi_video.php?nip=<?php echo $data['nip']?>" class="btn btn-success">Upload</a>
            <?php } ?>
    <p><br/></p>
		<table class="table table-bordered table-striped table-hover">
			<thead>
				<tr align='center'>
                    ...
                    <th width="80%"> <center> Embed Link </center></th>
			...
			<tbody>
				...
				<?php
					...
					//$output = "";
					$sql = mysqli_query($con, "SELECT * FROM gallery_video ORDER BY no_video");
					while($result = mysqli_fetch_assoc($sql))
					{
						?>
							<tr>
								...
								<td>
								<?php
								echo $result['link'] . '</strong><br /> <br />';
								?>
                                </td>
								
								 <td> <i> <a href="delete_video.php?no_video=<?php echo $result['no_video']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
