...
<?php  
	...
	<img src="siswafoto/<?php echo $data['foto'] ?>" style="text-align:center" width="20%"/>
	</div>
	<br/><br/>
	
        <form method="post" action="proses_foto_siswa.php<?php echo "?no_induk=$no_induk&nip=$nip" ?>" class="form-horizontal" enctype="multipart/form-data">
        ...
        <i>
		<a href="update_datasiswa.php<?php echo "?no_induk=$no_induk&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i> 
            </div>
                <?php } ?>
                </div>
            </div>
