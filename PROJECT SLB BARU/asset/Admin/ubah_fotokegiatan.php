...
<?php  
    ...
    $query_mysqli = mysqli_query($link,"SELECT * FROM kegiatan WHERE id_kegiatan = '$id_kegiatan'")or die(mysqli_error($link));
    while($data = mysqli_fetch_array($query_mysqli)) {
    ?>
    <div id="collapse2" class="body">
	<div style="text-align:center">
	<img src="kegiatanfoto/<?php echo $data['foto_judul'] ?>" style="text-align:center" width="20%"/>
	</div>
	<br/><br/>
	
        <form method="post" action="proses_foto_kegiatan.php<?php echo "?id_kegiatan=$id_kegiatan&nip=$nip" ?>" class="form-horizontal" enctype="multipart/form-data">
			
                    <div class="form-group">
                        <label class="control-label col-lg-4">Foto Kegiatan</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-actions no-margin-bottom">
                        <input type="submit" name="upload" value="UPDATE" class="btn btn-primary" style="margin-left: 47%">
                    </div>
        </form>
        <i>
		<a href="update_kegiatan3.php<?php echo "?id_kegiatan=$id_kegiatan&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i> 
            </div>
                <?php } ?>
                </div>
            </div>
