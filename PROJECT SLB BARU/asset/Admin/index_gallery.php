...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Laporan Gallery Foto</h5>
            </header>
            <div id="collapse4" class="body"><a  href="isi_gallery.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Foto </a>
                <?php } ?>
...
<?php
    $nomor=1;
include 'konek.php';
$query = "SELECT * FROM gallery_foto"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="25%"><center> Nomor Foto </center></th>
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="delete_gallery.php?no_foto=<?php echo $data['no_foto']?>&nip=<?php echo $nip ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
    </tr>
    <?php } ?> 
                    </tbody>
</table>
