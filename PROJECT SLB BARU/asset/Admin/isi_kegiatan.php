...
?>
        <div id="collapse2" class="body">
			<form action="proses_isi_kegiatan.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="bulan_kegiatan">
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="file" name="foto_judul" id="foto_judul">
                        </div>
                </div>
                
                <div class="form-group">
                        <label class="control-label col-lg-4">Foto isi 1</label>
                        <div class="col-lg-4">
                ...
                <div class="form-group">
                        <label class="control-label col-lg-4">Foto isi 2</label>
                        <div class="col-lg-4">
                ...
                <div class="form-group">
                        <label class="control-label col-lg-4">Foto isi 3</label>
                        <div class="col-lg-4">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea name="isi" cols="40" rows="4" class="form-control"> </textarea>
                        </div>
                </div>
				...
				<div class="form-actions no-margin-bottom">
                    ...
                    <i>
		<a href="index_kegiatan.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
				</form>
                </div>
            </div>
