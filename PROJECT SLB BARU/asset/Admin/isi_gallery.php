...
?>
        <div id="collapse2" class="body">
			<form action="proses_isi_gallery.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="form-actions no-margin-bottom">
                    ...
                    <i>
		<a href="index_gallery.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
				</form>
