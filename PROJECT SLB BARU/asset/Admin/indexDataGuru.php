...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse4" class="body"><a  href="InputGuru.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary"> Tambah Data Baru</a>
                  <?php } ?>
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM data_guru"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="10%"><center> Nip </center></th>
                        <th width="10%"><center> Foto Guru </center></th>
                        <th width="10%"><center> Nama Guru </center></th>
                        <th width="10%"><center> Jenis Kelamin </center></th>
                        <th width="10%"><center> Tempat Lahir </center></th>
                        <th width="10%"><center> Tanggal Lahir </center></th>
                        <th width="10%"><center> Pangkat </center></th>
                        <th width="10%"><center> Pendidikan Terakhir </center></th>
                        <th width="10%"><center> Jabatan </center></th>
                        <th width="10%"><center> Agama </center></th>
...
$articles="SELECT * FROM data_guru LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM data_guru order by nip desc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="editGuru.php<?php echo "?nip=$nip&nip1=$data[nip]" ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="hapusGuru.php<?php echo "?nip=$nip&nip1=$data[nip]" ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
