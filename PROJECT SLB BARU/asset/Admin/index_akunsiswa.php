...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Laporan Akun Siswa</h5>
            </header>
            <div id="collapse4" class="body"><a  href="isi_akunsiswa.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Baru</a>
                 <?php } ?>
...
$query = "SELECT * FROM akun_siswa"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);

    ?>
                        <tr>
                        <th width="30%"><center> No Induk </center></th>
                        <th width="30%"><center> Password </center></th>
...
$articles="SELECT * FROM akun_siswa LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM akun_siswa order by no_induk desc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_akunsiswa.php?<?php echo "nip=$nip&no_induk=$data[no_induk]" ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_akunsiswa.php?<?php echo "nip=$nip&no_induk=$data[no_induk]" ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
