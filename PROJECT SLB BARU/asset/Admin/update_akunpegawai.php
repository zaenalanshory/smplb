...
$nip1=$_GET['nip1'];
$query = "SELECT * FROM akun_pegawai WHERE nip = $nip1"; //get the data that will be updated
$hasil = mysqli_query($link,$query);
$data  = mysqli_fetch_array($hasil);
?>
     <div id="collapse2" class="body">
         <form action="proses_update_akunpegawai.php<?php echo "?nip=$nip&nip1=$nip1" ?>" method="post" class="form-horizontal">
             ...
             <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="hak_akses" value="<?php echo $data['hak_akses']; ?>">
                </div>
             </div>
