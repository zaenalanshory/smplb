...
<?php  
	...
	<img src="kegiatanfoto/<?php echo $data['foto2'] ?>" style="text-align:center" width="20%"/>
	</div>
	<br/><br/>
	
        <form method="post" action="proses_foto2_kegiatan.php<?php echo "?id_kegiatan=$id_kegiatan&nip=$nip" ?>" class="form-horizontal" enctype="multipart/form-data">
