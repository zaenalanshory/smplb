...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header>
                <h5>Edit Data Ajar</h5>
            </header>
            <div id="collapse4" class="body">
<?php
include 'konek.php';
$id_ajar = $_GET['id_ajar']; //get the no which will updated
$nip = $_GET['nip'];
$query = "SELECT * FROM data_ajar WHERE id_ajar = '$id_ajar'"; //get the data that will be updated
$hasil = mysqli_query($link,$query);
$data  = mysqli_fetch_array($hasil) or die('Error: ' . mysqli_error($link));
?>
     <div id="collapse2" class="body">
         <form action="proses_update_dataajar.php<?php echo "?nip=$nip&id_ajar=$id_ajar" ?>" method="post" class="form-horizontal">
             <div class="form-group">
                <label class="control-label col-lg-4">Id Ajar</label>
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="id_ajar" value="<?php echo $data['id_ajar']; ?>">
                </div>
             </div>
             ...
             <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="nip1" value="<?php echo $data['nip']; ?>">
                </div>
             </div>
             ...
             <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="kode_mapel" value="<?php echo $data['kode_mapel']; ?>">
                </div>
             </div>
             
             <div class="form-actions no-margin-bottom">
                    <input type="hidden" class="form-control" name="id_ajar" value="<?php echo $data['id_ajar']; ?>">
