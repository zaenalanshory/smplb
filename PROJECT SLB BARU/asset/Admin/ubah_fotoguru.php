...
<div class="row">
  <div class="col-lg-12">
	...
	<img src="gurufoto/<?php echo $data['foto'] ?>" style="text-align:center" width="20%"/>
	</div>
	<br/><br/>
	
        <form method="post" action="proses_foto_guru.php<?php echo "?nip=$nip&nip1=$nip1" ?>" class="form-horizontal" enctype="multipart/form-data">
		...
		<i>
		<a href="editGuru.php<?php echo "?nip=$nip&nip1=$nip1" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>  
            </div>
			 <?php } ?>
            </div>
   </div>
