...
?>
			...
			<form action="proses_isi_mapel.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                        <label class="control-label col-lg-4">Nama Mata Pelajaran</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-actions no-margin-bottom">
                        ...
                        <i>
		<a href="index_mapel.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
                </form>
            </div> 
    </div>
