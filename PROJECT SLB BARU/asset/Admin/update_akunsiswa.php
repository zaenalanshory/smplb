...
<?php
include 'konek.php';
$no_induk = $_GET['no_induk']; //get the no which will updated
$nip = $_GET['nip'];
$query = "SELECT * FROM akun_siswa WHERE no_induk = '$no_induk'"; //get the data that will be updated
$hasil = mysqli_query($link,$query) or die('Error: ' . mysqli_error($link));
$data  = mysqli_fetch_array($hasil);
?>
     <div id="collapse2" class="body">
         <form action="proses_update_akunsiswa.php?<?php echo "nip=$nip&no_induk=$no_induk" ?>" method="post" class="form-horizontal">
             <div class="form-group">
                <label class="control-label col-lg-4">Nomor Induk</label>
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="no_induk" value="<?php echo $data['no_induk']; ?>">
                </div>
             </div>
