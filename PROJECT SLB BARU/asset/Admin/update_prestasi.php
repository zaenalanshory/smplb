...
$nomor = $_GET['nomor'];
$nip = $_GET['nip'];
$query = "SELECT * FROM prestasi WHERE nomor = $nomor"; //get the data that will be updated
$hasil = mysqli_query($link,$query);
$data  = mysqli_fetch_array($hasil);
?>
                
     <div id="collapse2" class="body">
         <form action="proses_update_prestasi.php?<?php echo "nip=$nip&nomor=$nomor" ?>" method="post" class="form-horizontal">
             ...
             <div class="form-group">
                <label class="control-label col-lg-4">Keterangan Prestasi</label>
                <div class="col-lg-4">
                    <textarea name="ket_prestasi" class="form-control"> <?php echo $data['ket_prestasi']; ?> </textarea>
                </div>
             </div>
         ...
         <i>
<a href="index_prestasi.php<?php echo "?nomor=$nomor&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
<a href="ubah_fotoprestasi.php<?php echo "?nomor=$nomor&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Ubah Foto</a>
                </div>
            </div>
      </div>
    </div>
