...
<body class="  ">
    <div class="bg-dark dk" id="wrap">
        <div id="top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        ...
                        <ul class="nav navbar-nav">
                            <li  style="margin-left: -200%; margin-top: -5%"><a href="#smplb-aypab.html">SMPLB-YPAB</a></li>
                        </ul>
                        <!-- /.nav -->
                    </div>
                </div>
            ...
            <header class="head">
                ...
                <div class="main-bar">
                    <h3>
                        <i class="fa fa-home"></i>&nbsp; SMPLB-AYPAB
                    </h3>
                </div>
                <!-- /.main-bar -->
            </header>
    ...
    $nip=$_GET['nip'];
    $query_mysqli = mysqli_query($link,"SELECT * FROM data_siswa WHERE no_induk = '$no_induk'")or die(mysqli_error($link));
    while($data = mysqli_fetch_array($query_mysqli)) {
    ?>
    <form class="form-horizontal" id="popup-validation" method="post" action="proses_update_datasiswa.php<?php echo "?nip=$nip&no_induk=$no_induk" ?>">

                    <div class="form-group">
                        <label class="control-label col-lg-4">Nama Siswa</label>
                        <div class="col-lg-4">
                            <input type="hidden" name="no_induk" value="<?php echo $data['no_induk'] ?>">
                            <input type="text" class="form-control" name="nama_siswa" autocomplete="off" value="<?php echo $data['nama_siswa'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" name="alamat" autocomplete="off" cols="40" rows="4"><?php echo $data['alamat'] ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="nama_ayah" autocomplete="off" value="<?php echo $data['nama_ayah'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="nama_ibu" autocomplete="off" value="<?php echo $data['nama_ibu'] ?>">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label col-lg-4">No Telepon Orang Tua</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="no_telp_orangtua" autocomplete="off" value="<?php echo $data['no_telp_orangtua'] ?>">
                        </div>
                    </div>
                    
                    <div class="form-actions no-margin-bottom">
                        <input type="submit" name="ok1" value="SAVE" class="btn btn-primary" style="margin-left: 47%">
                    </div>
                </form>
                <i>
<a href="index_datasiswa.php<?php echo "?no_induk=$no_induk&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
<a href="ubah_fotosiswa.php<?php echo "?no_induk=$no_induk&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Ubah Foto</a>
    <?php } ?>
                            </div>
