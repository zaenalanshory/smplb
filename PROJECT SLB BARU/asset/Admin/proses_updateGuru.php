...
tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', pangkat='$pangkat', jabatan='$jabatan', pendidikan_terakhir='$pendidikan_terakhir', agama='$agama' WHERE nip='$nip1'";	
