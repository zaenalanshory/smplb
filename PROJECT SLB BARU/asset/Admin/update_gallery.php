...
$query = "SELECT * FROM gallery_foto WHERE no_foto = $no_foto"; //get the data that will be updated
$hasil = mysqli_query($link,$query);
$data  = mysqli_fetch_array($hasil);
?>
     <div id="collapse2" class="body">
         <form action="proses_update_gallery.php<?php echo "?nip=$nip&no_foto=$no_foto" ?>" method="post" class="form-horizontal">
             <div class="form-group">
                <label class="control-label col-lg-4">Nomor</label>
                <div class="col-lg-4">
                    <input type="text" class="form-control" name="no_foto" disabled='disable' value="<?php echo $data['no_foto']; ?>">
                </div>
             </div>
             ...
             <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="file" name="foto" <?php echo $data['foto']; ?>>
                </div>
             </div>
          ...
          <i>
<a href="index_gallery.php<?php echo "?no_foto=$no_foto&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
<a href="ubah_fotogallery.php<?php echo "?no_foto=$no_foto&nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Ubah Foto</a>
                </div>
            </div>
      </div>
    </div>
