...
?>
                ...
                <form class="form-horizontal" id="popup-validation" method="post" action="proses_isi_datasiswa.php<?php echo "?nip=$nip" ?>" enctype="multipart/form-data">

                    <div class="form-group">
                        <label class="control-label col-lg-4">No Induk</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="no_induk" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-4">Foto siswa</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" name="alamat" cols="40" rows="4" autocomplete="off"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="no_telp_orangtua" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-actions no-margin-bottom">
                        ...
                        <i>
		<a href="index_datasiswa.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                    </div>
                </form>
            </div>
