                    ...
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="assets/img/logo.png" style="width: 25%">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li><a href="#smplb-aypab.html">SMPLB-A YPAB</a></li>
                                </ul>
                                <!-- /.nav -->
                            </div>
                        </div>
...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header> 
                <h5>Laporan Akun Pegawai</h5>
            </header>
            <div id="collapse4" class="body"><a  href="isi_akunpegawai.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Baru</a>
                 <?php } ?>
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
<?php
include 'konek.php';
$query = "SELECT * FROM akun_pegawai"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);
    ...
    ?>
                        ...
                        <th width="20%"><center> Hak akses </center></th>
...
$articles="SELECT * FROM akun_pegawai LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM akun_pegawai order by nip desc");
...
?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_akunpegawai.php<?php echo "?nip=$nip&nip1=$data[nip]" ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_akunpegawai.php<?php echo "?nip=$nip&nip1=$data[nip]" ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
