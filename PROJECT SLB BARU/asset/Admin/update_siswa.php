...
<body class="  ">
	...
	include "konek.php";
    $id = $_GET['id'];
    $query_mysqli = mysqli_query($host,"SELECT * FROM data_siswa WHERE no_induk = '$id'")or die(mysqli_error($host));
    while($data = mysqli_fetch_array($query_mysqli)) {
	
?>
    <form class="form-horizontal" id="popup-validation" method="post" action="updateSiswa.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="foto" autocomplete="off" value="<?php echo $data['foto'] ?>">
                        </div>
                    </div>
