...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse4" class="body"><a  href="isi_prestasi.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Prestasi </a>
                <?php } ?>
...
<?php
 $nomor=1;                       
include 'konek.php';
$query = "SELECT * FROM prestasi"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);
?>
                        <tr>
                        <th width="25%"><center> Nomor </center></th>
                        <th width="25%"><center> ID </center></th>
                        <th width="25%"><center> Nama Siswa </center></th>
                        <th width="25%"><center> Keterangan Prestasi </center></th>
...
$articles="SELECT * FROM prestasi LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM prestasi order by nomor desc");
...
{ ?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_prestasi.php?<?php echo "nip=$nip&nomor=$data[nomor]" ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_prestasi.php?<?php echo "nip=$nip&nomor=$data[nomor]" ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
