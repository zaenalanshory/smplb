...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse4" class="body"><a  href="isi_rapot.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Raport </a>
                <?php } ?>
...
<?php
 $nomor=1;                       
include 'konek.php';
$query = "SELECT * FROM rapot order by no_induk ASC"; //the query for get all data in tb_student
$result = mysqli_query($link,$query);
?>
                        <tr>
                        <th width="10%"><center> No </center></th>
                        <th width="10%"><center> No Induk </center></th>
                        <th width="10%"><center> Kode Mapel </center></th>
...
$articles="SELECT * FROM rapot order by no_induk ASC LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM rapot order by no_induk ASC");
...
{ ?>
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="update_rapot.php?<?php echo "nip=$nip&no=$data[no]" ?>" type="submit" value="Validate" class="btn btn-primary"> Update </a> </i></td>
            <td> <i> <a href="delete_rapot.php?<?php echo "nip=$nip&no=$data[no]" ?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
