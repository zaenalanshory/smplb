...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            <header>
                <h5>Input Data Siswa Berprestasi</h5>
            </header>
        ...
        <div id="collapse2" class="body">
			...
			<form action="proses_isi_prestasi.php<?php echo "?nip=$nip" ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea name="ket_prestasi" cols="40" rows="4" class="form-control" name="nama_siswa"> </textarea>
                        </div>
                </div>
				...
				<div class="form-actions no-margin-bottom">
                    ...
                    <i>
		<a href="index_prestasi.php<?php echo "?nip=$nip" ?>" value="validate" class="btn btn-primary" type="submit">Batal</a></i>
                 </div>
                </div>
				</form>
