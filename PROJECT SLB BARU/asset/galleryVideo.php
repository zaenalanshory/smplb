...
$articles="SELECT * FROM gallery_video LIMIT $start, $perPage";
$result2=mysqli_query($link, $articles);

$result=mysqli_query($link, "SELECT * FROM gallery_video order by no_video desc");
	...
	<?php while($row=mysqli_fetch_assoc($result2)) { ?>
     <li class="one_third">
        <article class="element">
          <figure><iframe width="320" height="315" src="<?php echo $row['link'] ?>"></iframe>
          </figure>
        </article>
      </li>
          <?php } ?>
