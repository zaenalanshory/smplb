...
<ul class="nospace group btmspace-50">
    ...
    <?php
    $query = "SELECT * FROM data_guru order by nip ASC";
      ...
      <li class='one_third latar box besar'>
		<center>
		  <h6 class='heading'> <p class='box besar'><?php echo $data['jabatan'] ?></p>
            <article class='element'>
		      <figure> <a href='detailDataGuru.php?nip=<?php echo $data['nip']?>'> <img class='img-circle' src='Admin/<?php echo $data['foto'] ?>' style='width: 200px;height:300px;'alt=''> </a> 
            </figure>
        <div class='excerpt1'>
