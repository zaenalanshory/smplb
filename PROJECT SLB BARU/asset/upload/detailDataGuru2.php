...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/guru.jpg');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h2 class="heading">Profil Guru Detail</h2>
    </article>
    <!-- ################################################################################################ -->
  </div>
</div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-50">
     ...
     <center>
         <figure> <img class="img-circle" src="images/demo/fotoGuru/Dwi%20Rahmawati.JPG" style="width: 200px;height:300px;"alt=""> </figure>
            <table class="table" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="fd9c03">
                <tr>
                    <td style="font-weight:bold;" width="">Nama</td>
                    <td style="font-weight:bold;" width="">:</td>
                    <td> DWI RAHMAWATI, S.Pd </td>
                </tr>
                <tr>
                    <td style="font-weight:bold;">NIP</td>
                    <td style="font-weight:bold;">:</td>
                    <td> 19660216 198803 2 018 </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="font-weight:bold;"> Tempat dan Tanggal Lahir</td>
                    <td style="font-weight:bold;">:</td>
                    <td> Malang, 16 Februari 1966 </td>
                </tr>
				<tr>
                ...
                <tr>
                    <td style="font-weight:bold;">Alamat Surabaya</td>
                    <td style="font-weight:bold;">:</td>
                    <td>MasanganWetan,sid___</td>
                </tr>
                </table>
      </center>
    </main>
