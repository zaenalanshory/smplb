...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-50">
     ...
     <center>
         <figure> <img class="img-circle" src="images/demo/fotoGuru/Umi%20Sa_adah.JPG" style="width: 200px;height:300px;"alt=""> </figure>
            <table class="table" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="fd9c03">
                <tr>
                    ...
                    <td> Hj. UMI SA`ADAH, M.S.I </td>
                </tr>
                <tr>
                    <td style="font-weight:bold;">NIP</td>
                    <td style="font-weight:bold;">:</td>
                    <td> 19710724 200112 2 002 </td>
                </tr>
                <tr>
