...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/oo.jpg');">
            <div id="pageintro" class="hoc clear"> 
                <!-- ################################################################################################ -->
                <article>
                    <h2 class="heading">Contact Us</h2>
                    <p>Sebuah Halaman untuk Memberikan Pesan dan Saran</p>
            ...
            <div class="wrapper row3 latar">
                <div class="latar">
                    <main class="hoc container clear latar box besar"> 
                        <!-- main body -->
                        <!-- ################################################################################################ -->
                        <div class="content latar"> 
                            <!-- ################################################################################################ -->
                            <br>
                            <br>
                            <center><h1> <p class="box besar">SMPLB-A YPAB</p></h1>
                                <p class="box besar">Alamat  : Jalan Gebang Putih No. 5, Gebang Putih, Sukolilo, Surabaya, Jawa Timur.</p>
                                <p class="box besar">Telepon : 031-5945490</p>
                                <p class="box besar">E-mail  : smplba_ypabs@yahoo.com</p>
                            </center>

                        </div>
                        <div class="latar">
                            <div id="comments" class="latar">
                                <h2>Komentar</h2>
                                <ul class="latar box besar">
                                                          <?php
                                        ...
                                        while($data = mysqli_fetch_assoc($hasil)){
                                            echo "
                                    <li class='latar box besar'>
                                        <article>
                                            <header>
                                                <figure class='avatar'><img src='../images/demo/avatar.png'></figure>
                                                <address>
                                                    By <a href='#'>$data[nama]</a>
                                                </address>
                                                <time>$data[email]</time>
                                            </header>
                                            <div class='comcont'>
                                                <p class='box besar'>$data[komentar]</p>
                                            </div>
                                        </article>
                                    </li>
                                            ";
                                ...
                                <form action="update_contact.php" method="post">
                                    <div class="one_third first">
                                        ...
                                        <input class="latar" type="text" name="name" id="name" value="" size="22" required>
                                    </div>
                                    <div class="one_third">
                                        <label for="email">Mail <span>*</span></label>
                                        <input class="latar" type="email" name="email" id="email" value="" size="22" required>
                                    </div>
                                    <div class="block clear latar box besar">
                                        <label for="comment">Your Comment</label>

                                        <textarea name="comment" id="comment" cols="25" rows="10" class="latar"></textarea>

                                    </div>
                                    <input class="latar" type="submit" name="submit" value="Submit Form">
                                    &nbsp;
                                    <input  class="latar" type="reset" name="reset" value="Reset Form">
                                    <br>
                                    <br>
