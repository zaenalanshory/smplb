...
<?php
            include "konek.php";
    $qs = mysqli_query($host, "SELECT * FROM data_siswa");
    $nomor = 1;
    while($data = mysqli_fetch_array($qs)) {
?>
<tr class="box besar">
	<td class="center"><?php echo $nomor++; ?></td>
	<td><figure> <center><img class="img-box" src="images/demo/<?php echo $data["foto"]; ?>" style="width: 200px; height:150px" alt=""></center> </figure></td>
	<td class="box besar"><?php echo $data["no_induk"]; ?></td>
	<td class="box besar"><?php echo $data["nama_siswa"]; ?></td>
	<td class="box besar"><?php echo $data["jenis_kelamin"]; ?></td>
</tr>
            <?php
            }
            ?>
