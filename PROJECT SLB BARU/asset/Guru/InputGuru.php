...
?>
			...
			<form action="simpanGuru.php" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <textarea type="text" class="form-control" name="alamat" cols="40" rows="4"></textarea>
                        </div>
                    </div>
