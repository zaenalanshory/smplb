...
<div class="row">
  <div class="col-lg-12">
	...
	<img src="fotoGuru/<?php echo $data['foto'] ?>" style="text-align:center" width="20%"/>
	</div>
	<br/><br/>
	
        <form method="post" action="proses_foto.php<?php echo "?nip=$nip" ?>" class="form-horizontal" enctype="multipart/form-data">
			
                    <div class="form-group">
                        <label class="control-label col-lg-4">Foto Identitas</label>
                        <div class="col-lg-4">
		...
		<button type="button" class="btn btn-danger" style="float:left;"><a href="editGuru.php<?php echo "?nip=$nip" ?>" style="color:white;">Batal</a></button> 
            </div>
			 <?php } ?>
            </div>
   </div>
