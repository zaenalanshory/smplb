                        ...
                        <ul id="menu" class="bg-blue dker">
                                  ...
                                  <li class="nav-divider"></li>
                                   <li class="">
                                    ...
                                    <ul class="collapse">
                                      <li>
                                        <a href="indexDataGuru.php">
                                          <i class="fa fa-angle-right"></i>&nbsp; Input Data Guru </a>
                                      </li>
                                      <li>
                                ...
                                <li class="">
                                    <a href="javascript:;">
                                      <i></i>
                                      <span class="link-title"> Data Ajar </span>
                                      <span class="fa arrow"></span>
                                    </a>
                                </li>
...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse4" class="body"><a  href="InputGuru.php" type="submit" value="Validate" class="btn btn-primary">+ Tambah Data Baru</a>
...
$result = mysqli_query($link,$query);
  ...
  <tr align='center'>
            ...
            <td> <i> <a href="hapusGuru.php?nip=<?php echo $data['nip']?>" type="submit" value="Validate" class="btn btn-primary" >Hapus </a> </i></td>
       </tr>
