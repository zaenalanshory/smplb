...
<div class="row">
  <div class="col-lg-12">
    ...
    <div id="collapse2" class="body">
        <form method="post" action="proses_updateGuru.php<?php echo "?nip=$nip" ?>" class="form-horizontal">
		...
		<button type="button" class="btn btn-danger" style="float:left;"><a href="menu_utama_guru.php<?php echo "?nip=$nip" ?>" style="color:white;">Batal</a></button> 
